...
void EnemyShip::Render(Shader* shader) const
{
	...
	glUniform4fv(shader->GetUniformID("meshColor"), 1, Vec4(health / 5, 0.0f, 0.0f, 0.0f)); //for now just make the color correlate directly with health (5 is a temp hardcoded max health value)
